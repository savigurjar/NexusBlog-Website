...
function AddBlog() {
  ...
  const [isPublished, setIsPunlished] = useState(false);
    ...
    <form className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll '>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <div className='flex gap-2 mt-4'>
          <p>Publish Now</p>
          <input type='checkbox' checked={isPublished} className='scale-125 cursor-pointer' onChange={(e) => setIsPunlished(e.target.checked)}>
          </input>
        </div>
